...
if (isset($_POST["affiliate_id"]) && isset($_POST['affiliate_include'])) {

    $affiliate_id = retrieveAffiliateId($_POST["affiliate_id"]);

    $sql = "update affiliates set pendingDepositInclude = 1 where id =" . (int)$affiliate_id;
    ...
    $sql = "update affiliates set pendingDepositInclude = 0 where id =" . (int)$_POST['affiliate_id'];
    function_mysql_query($sql);

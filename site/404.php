...
<html i18n-values="dir:textdirection;lang:language" dir="ltr" lang="en" i18n-processed=""><head>
  ...
  <title i18n-content="title"><?php echo $baseurl;?></title>
...
<body id="t" i18n-values=".style.fontFamily:fontfamily;.style.fontSize:fontsize" jstcache="0" class="neterror" style="font-family: &quot;Segoe UI&quot;, Tahoma, sans-serif; font-size: 75%;">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jsselect="heading" jsvalues=".innerHTML:msg" jstcache="5">This <span jscontent="hostName" jstcache="16"><?php echo $baseurl;?></span> page can't be found</h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2">No webpage was found for the web address: <strong jscontent="failedUrl" jstcache="17">http://<?php echo $baseurl;?></strong></p>
        <div id="suggestions-list" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="6">
          ...
          <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? 'single-suggestion' : ''" jstcache="14" class="">
            <li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="15" jsinstance="0">Go to <a jsvalues="href:urlCorrection;.jstdata:$this" onmousedown="linkClicked(this.jstdata)" jscontent="urlCorrectionForDisplay" jstcache="18" href="<?php echo $baseurl;?>"><?php echo $baseurl;?></a></li><li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="15" jsinstance="*1">Search Google for <a jsvalues="href:searchUrl;.jstdata:$this" onclick="linkClicked(this.jstdata)" jscontent="searchTerms" id="search-link" jstcache="19" href="https://www.google.com/search?q=<?php echo str_replace(' ','%20',str_replace('/', ' ' ,str_replace('.',' ' ,$baseurl)));?>"><?php echo str_replace('/', ' ' ,str_replace('.',' ' ,$baseurl));?></a></li>
          </ul>
        </div>
        <div class="error-code" jscontent="errorCode" jstcache="7">HTTP ERROR 404 F.</div>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2">No webpage was found for the web address: <strong jscontent="failedUrl" jstcache="17">http://<?php echo (($baseurl));?></strong></div>
  </div>

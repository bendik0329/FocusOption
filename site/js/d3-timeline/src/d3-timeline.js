...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        tickFormat = { format: d3.time.format("%d %B"),
      ...
      function setHeight() {
        if (!height && !gParentItem.attr("height")) {
          if (itemHeight) {
            ...
            height = gSize.height + gSize.top - gParentSize.top+70;
    ...
    timeline.ticks = function (tickProp) {
      if (!arguments.length) return tickFormat.tickInterval;
      tickFormat.tickInterval = tickProp;
      return timeline;
    };

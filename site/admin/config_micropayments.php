...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tblDetails"><div class="question tooltip"><span class="tooltiptext">'. $tooltips['micropayments'] .'</span></div>&nbsp;&nbsp;<div class="exclamation tooltip"><span class="tooltiptext">'. lang("Only available for Affiliate Buddies Admin.") .'</span></div>
							<tr>
								...
								<input type="text" id="showMicroPaymentsOnReportsRate" placeholder="{COUNYRY-CODE}="  name="db[showMicroPaymentsOnReportsRate]" style="width:100px" value="'.$set->showMicroPaymentsOnReportsRate.'"/><div class="question tooltip"><span class="tooltiptext">'.$tooltips['showMicroPaymentsOnReportsRate'] .'</span></div></div>
								</td>
							</tr>
							</table>';

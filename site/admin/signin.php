                        ...
                        <div class="col-12 d-flex align-items-center justify-content-center">
                            <div class="b-sing b-register">
                                ...
                                <div class="card border-grey border-lighten-3 px-2 py-2 m-0 box-shadow-2">
                                    ...
                                    <form class="form-horizontal form-simple needs-validation" novalidate  id="SignInFormAdmin">
                                        <div class="header-sing  text-center mb-2">
                                            <h1>
                                                <?= lang('Sign In to your'); ?><br>
                                                <b><?= lang('Admin Account'); ?></b>
                                            </h1>
                                        </div>
                                        <div class="card-content">
                                            ...
                                            <button id="SignInBtnAdmin" type="submit" class="btn btn-primary btn-block"><?= lang('Sign In'); ?></button>
